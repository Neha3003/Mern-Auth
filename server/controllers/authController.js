...
import sendMail from '../config/resendMailer.js'
import { EMAIL_VERIFY_TEMPLATE, PASSWORD_RESET_TEMPLATE } from '../config/emailTemplates.js';
 ...
 export const register = async (req, res)=> {
    ...
    try{
        ...
        to: email,
        subject: "Welcome TO Designs",
        text: `Welcome to designs website. Your account has been created with email id: ${email}`,
       };
