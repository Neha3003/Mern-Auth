  ...
  return (
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-linear-to-br from-blue-200 to-purple-400'>
      ...
      <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 test-sm'>
        ...
        <p className='text-center mb-6 text-indigo-300'>Enter your registered email account.</p>
        ...
        <button className='w-full py-2.5 bg-linear-to-r from-indigo-500 to-indigo-900 rounded-full mt-3 text-white'>Submit</button>
      </form>
      }
      ...
      <form onSubmit={onSubmitOtp} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 test-sm'>
        ...
        <button className='w-full py-2.5 bg-linear-to-r from-indigo-500 to-indigo-900 rounded-full'>Submit</button>
      </form>
      }
